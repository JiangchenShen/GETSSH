...
### 🟠 [H-02] [✅ 已修复] `PluginPane` 的 `allow-same-origin` 沙盒逃逸
...
### 🟠 [H-03] [✅ 已修复] CSP 宽松：`unsafe-inline` + `unsafe-eval`
...
### 🔴 [C-06] [✅ 已修复] SFTP 大文件"一口吞"导致 OOM 崩溃
