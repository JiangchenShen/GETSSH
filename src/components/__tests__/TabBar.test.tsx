...
describe('TabBar Component', () => {
  ...
  const defaultProps = {
    tabs: [
      { id: 'tab1', title: 'Server 1', config: { host: "localhost", port: 22, username: "test" } },
      { id: 'tab2', title: 'Server 2', config: { host: "localhost", port: 22, username: "test" } },
    ],
    activeTabId: 'tab1',
    isDark: true,
    onSelectTab: vi.fn(),
  ...
  it('filters out the settings tab', () => {
    const props = {
      ...
      tabs: [
        ...defaultProps.tabs,
        { id: 'settings', title: 'Settings', config: { host: "localhost", port: 22, username: "test" } },
      ],
    };
    render(<TabBar {...props} />);
  ...
  it('renders nothing if there are no SSH tabs', () => {
    const props = {
      ...defaultProps,
      tabs: [{ id: 'settings', title: 'Settings', config: { host: "localhost", port: 22, username: "test" } }],
    };
